...
ALTER TABLE proposals ADD COLUMN IF NOT EXISTS fx_eur NUMERIC;
ALTER TABLE proposals ADD COLUMN IF NOT EXISTS fx_usd NUMERIC;
ALTER TABLE proposals ADD COLUMN IF NOT EXISTS fx_gbp NUMERIC;
